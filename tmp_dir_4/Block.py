...
class Block():
    ...
    def construct(self):
        ...
        conv_layers_bis = [
                layers.Conv2D(10, (2, 10), padding="same", activation='relu', name=self.name+"-2_10-bis"),
                layers.Conv2D(10, (2, 5), padding="same", activation='relu', name=self.name+"-2_5-bis"),
                layers.Conv2D(10, (2, 5), dilation_rate=4, padding="same", activation='relu', name=self.name+"-2_5_dl-4-bis"),
                layers.Conv2D(10, (2, 10), dilation_rate=4, padding="same", activation='relu', name=self.name+"-2_10_dl-4-bis"),
                layers.Conv2D(10, (8, 1), padding="same", activation='relu', name=self.name+"-8_1-bis"),
                layers.Conv2D(10, (1, 900), padding="same", activation='relu', name=self.name+"-1_900-bis"),
