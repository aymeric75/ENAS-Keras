...
def main():
    ...
    controller_instance = Controller(num_block_conv=num_block_conv, num_block_reduc=num_block_reduc, num_op_conv=7, num_op_reduc=4, num_alt=num_alt, scheme=2, path_train="./data_conv_training.mat", path_test="./data_conv_testing.mat")
    ...
    callbacks = []
    nb_child_epochs = 6  #A CHANGER DANS LES PARAMETRES !!!!!!!!!!!!!!!!!!!!!!!!!!!!  ==============================v
    controller_instance.train(strategy, global_batch_size, callbacks, rew_func_exp_2, data_options, nb_child_epochs=6, mva1=50, mva2=500, epochs=1200)
